...
namespace vi {
TLSWebsocketEndpoint::TLSWebsocketEndpoint() : _nextId(0) {
...
int TLSWebsocketEndpoint::connect(std::string const &uri,
  ...
  int newId = _nextId++;
  ConnectionMetadata<TLSClient>::ptr metadataPtr =
      websocketpp::lib::make_shared<ConnectionMetadata<TLSClient>>(
          newId, con->get_handle(), uri, observer);
  _connectionList[newId] = metadataPtr;

  con->set_open_handler(websocketpp::lib::bind(
      &ConnectionMetadata<TLSClient>::onOpen, metadataPtr, &_endpoint,
      websocketpp::lib::placeholders::_1));
  con->set_fail_handler(websocketpp::lib::bind(
      &ConnectionMetadata<TLSClient>::onFail, metadataPtr, &_endpoint,
      websocketpp::lib::placeholders::_1));
  con->set_close_handler(websocketpp::lib::bind(
      &ConnectionMetadata<TLSClient>::onClose, metadataPtr, &_endpoint,
      websocketpp::lib::placeholders::_1));
  con->set_message_handler(websocketpp::lib::bind(
      &ConnectionMetadata<TLSClient>::onMessage, metadataPtr, &_endpoint,
      websocketpp::lib::placeholders::_1, websocketpp::lib::placeholders::_2));

  con->set_ping_handler(websocketpp::lib::bind(
      &ConnectionMetadata<TLSClient>::onPing, metadataPtr, &_endpoint,
      websocketpp::lib::placeholders::_1, websocketpp::lib::placeholders::_2));

  con->set_pong_handler(websocketpp::lib::bind(
      &ConnectionMetadata<TLSClient>::onPong, metadataPtr, &_endpoint,
      websocketpp::lib::placeholders::_1, websocketpp::lib::placeholders::_2));

  con->set_pong_timeout_handler(websocketpp::lib::bind(
      &ConnectionMetadata<TLSClient>::onPongTimeout, metadataPtr, &_endpoint,
      websocketpp::lib::placeholders::_1, websocketpp::lib::placeholders::_2));
...
void TLSWebsocketEndpoint::close(int id, websocketpp::close::status::value code,
...
void TLSWebsocketEndpoint::sendBinary(int id,
...
ConnectionMetadata<TLSClient>::ptr
TLSWebsocketEndpoint::getMetadata(int id) const {
