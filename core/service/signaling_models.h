...
struct MessageType {
  ...
  FIELDS_MAP("request", request, "response", response, "notification",
             notification);
};
...
struct GetRouterRtpCapabilitiesResponse {
  ...
  struct Parameters {
    ...
    FIELDS_MAP("apt", apt, "level-asymmetry-allowed", levelAsymmetryAllowed,
               "packetization-mode", packetizationMode, "profile-level-id",
               profileLevelId, "x-google-start-bitrate", xGoogleStartBitrate);
  };
  ...
  struct Codec {
    ...
    FIELDS_MAP("kind", kind, "mimeType", mimeType, "clockRate", clockRate,
               "channels", channels, "rtcpFeedback", rtcpFeedback, "parameters",
               parameters, "preferredPayloadType", preferredPayloadType);
  };
  ...
  struct HeaderExtension {
    ...
    FIELDS_MAP("kind", kind, "uri", uri, "preferredId", preferredId,
               "preferredEncrypt", preferredEncrypt, "direction", direction);
  };
...
struct CreateWebRtcTransportRequest {
  ...
  struct Data {
    ...
    FIELDS_MAP("consuming", consuming, "producing", producing, "forceTcp",
               forceTcp, "sctpCapabilities", sctpCapabilities);
  };
...
struct CreateWebRtcTransportResponse {
  ...
  struct ICECandidate {
    ...
    FIELDS_MAP("type", type, "protocol", protocol, "foundation", foundation,
  ...
  struct ICEParameters {
    ...
    FIELDS_MAP("iceLite", iceLite, "password", password, "usernameFragment",
               usernameFragment);
  };
  ...
  struct SCTPParameters {
    ...
    FIELDS_MAP("MIS", MIS, "OS", OS, "isDataChannel", isDataChannel, "port",
               port, "maxMessageSize", maxMessageSize, "sctpBufferedAmount",
               sctpBufferedAmount, "sendBufferSize", sendBufferSize);
  };
  ...
  struct Data {
    ...
    FIELDS_MAP("id", id, "dtlsParameters", dtlsParameters, "iceCandidates",
               iceCandidates, "iceParameters", iceParameters, "sctpParameters",
               sctpParameters);
  };
...
struct JoinRequest {
  ...
  struct Parameters {
    ...
    FIELDS_MAP("level-asymmetry-allowed", levelAsymmetryAllowed,
               "packetization-mode", packetizationMode, "profile-level-id",
               profileLevelId, "x-google-start-bitrate", xGoogleStartBitrate,
               "minptime", minptime, "useinbandfec", useinbandfec, "profile-id",
               profileId);
  };
  ...
  struct Data {
    ...
    absl::optional<SCTPCapabilities> sctpCapabilities;
    FIELDS_MAP("displayName", displayName, "device", device, "rtpCapabilities",
               rtpCapabilities, "sctpCapabilities", sctpCapabilities);
  };
...
struct NewDataConsumerRequest {
  ...
  struct Data {
    ...
    FIELDS_MAP("id", id, "peerId", peerId, "dataProducerId", dataProducerId,
               "label", label, "protocol", protocol, "sctpStreamParameters",
...
struct NewConsumerRequest {
  struct SharingData {
    // 前视:front,后视:back,左视:left,右视:right
    absl::optional<std::string> trackName;
    FIELDS_MAP("trackName", trackName);
  };
  ...
  struct Parameters {
    ...
    FIELDS_MAP("sprop-stereo", spropstereo, "usedtx", usedtx, "minptime",
               minptime, "useinbandfec", useinbandfec);
  };
  ...
  struct Codec {
    ...
    FIELDS_MAP("mimeType", mimeType, "clockRate", clockRate, "channels",
               channels, "rtcpFeedback", rtcpFeedback, "parameters", parameters,
  ...
  struct Encoding {
    ...
    FIELDS_MAP("ssrc", ssrc, "maxBitrate", maxBitrate, "rtx", rtx,
  ...
  struct RTPParameters {
    ...
    FIELDS_MAP("encodings", encodings, "codecs", codecs, "headerExtensions",
               headerExtensions, "mid", mid, "rtcp", rtcp);
  };
  ...
  struct Data {
    ...
    absl::optional<AppData> appData;
    FIELDS_MAP("id", id, "peerId", peerId, "kind", kind, "type", type,
               "producerId", producerId, "producerPaused", producerPaused,
...
struct ProduceRequest {
  ...
  struct Parameters {
    ...
    absl::optional<int32_t> xGoogleStartBitrate;
    absl::optional<int32_t> profileId;
    FIELDS_MAP("apt", apt, "sprop-stereo", spropstereo, "usedtx", usedtx,
               "minptime", minptime, "useinbandfec", useinbandfec,
  ...
  struct Encoding {
    ...
    FIELDS_MAP("ssrc", ssrc, "active", active, "dtx", dtx, "maxBitrate",
               maxBitrate, "rid", rid, "scalabilityMode", scalabilityMode,
  ...
  struct Data {
    ...
    absl::optional<RTPParameters> rtpParameters;
    absl::optional<AppData> appData;
    FIELDS_MAP("transportId", transportId, "kind", kind, "rtpParameters",
               rtpParameters, "appData", appData);
  };
...
struct ProduceDataRequest {
  ...
  struct SCTPStreamParameters {
    ...
    absl::optional<bool> ordered;
    FIELDS_MAP("streamId", streamId, "maxRetransmits", maxRetransmits,
               "ordered", ordered);
  };
  ...
  struct Data {
    ...
    absl::optional<SCTPStreamParameters> sctpStreamParameters;
    absl::optional<AppData> appData;
    FIELDS_MAP("transportId", transportId, "label", label, "protocol", protocol,
               "sctpStreamParameters", sctpStreamParameters, "appData",
               appData);
  };
...
struct SetConsumerPreferredLayersRequest {
  struct Data {
    ...
    FIELDS_MAP("consumerId", consumerId, "spatialLayer", spatialLayer,
...
struct GetTransportStatsResponse {
  struct ICESelectedTuple {
    ...
    absl::optional<std::string> protocol;
    FIELDS_MAP("localIp", localIp, "localPort", localPort, "remoteIp", remoteIp,
  ...
  struct Data {
    ...
    FIELDS_MAP("transportId", transportId, "type", type,
               "availableOutgoingBitrate", availableOutgoingBitrate,
               "bytesReceived", bytesReceived, "bytesSent", bytesSent,
               "dtlsState", dtlsState, "iceRole", iceRole, "iceSelectedTuple",
               iceSelectedTuple, "iceState", iceState, "maxIncomingBitrate",
               maxIncomingBitrate, "probationBytesSent", probationBytesSent,
               "probationSendBitrate", probationSendBitrate, "recvBitrate",
               recvBitrate, "rtpBytesReceived", rtpBytesReceived,
               "rtpBytesSent", rtpBytesSent, "rtpPacketLossReceived",
               rtpPacketLossReceived, "rtpSendBitrate", rtpSendBitrate,
               "rtxBytesReceived", rtxBytesReceived, "rtxBytesSent",
               rtxBytesSent, "rtxRecvBitrate", rtxRecvBitrate, "rtxSendBitrate",
               rtxSendBitrate, "sctpState", sctpState, "sendBitrate",
               sendBitrate, "timestamp", timestamp);
  };
...
struct GetProducerStatsResponse {
  ...
  struct Data {
    ...
    FIELDS_MAP("type", type, "kind", kind, "mimeType", mimeType, "rid", rid,
               "bitrate", bitrate, "byteCount", byteCount, "firCount", firCount,
               "fractionLost", fractionLost, "jitter", jitter, "nackCount",
               nackCount, "nackPacketCount", nackPacketCount, "packetCount",
               packetCount, "packetsDiscarded", packetsDiscarded, "packetsLost",
               packetsLost, "packetsRepaired", packetsRepaired,
               "packetsRetransmitted", packetsRetransmitted, "pliCount",
               pliCount, "roundTripTime", roundTripTime, "rtxPacketsDiscarded",
               rtxPacketsDiscarded, "rtxSsrc", rtxSsrc, "score", score, "ssrc",
               ssrc, "timestamp", timestamp, "bitrateByLayer", bitrateByLayer);
  };
...
struct GetDataProducerStatsResponse {
  struct Data {
    ...
    absl::optional<int64_t> timestamp;
    FIELDS_MAP("type", type, "label", label, "protocol", protocol,
               "bytesReceived", bytesReceived, "messagesReceived",
               messagesReceived, "timestamp", timestamp);
  };
...
struct GetConsumerStatsResponse {
  ...
  struct Data {
    ...
    FIELDS_MAP("type", type, "kind", kind, "mimeType", mimeType, "rid", rid,
               ...
               packetsLost, "packetsRepaired", packetsRepaired,
               "packetsRetransmitted", packetsRetransmitted, "pliCount",
               pliCount, "rtxPacketsDiscarded", rtxPacketsDiscarded, "rtxSsrc",
               rtxSsrc, "roundTripTime", roundTripTime, "score", score, "ssrc",
               ssrc, "timestamp", timestamp, "bitrateByLayer", bitrateByLayer);
  };
...
struct GetDataConsumerStatsResponse {
  struct Data {
    ...
    absl::optional<int64_t> timestamp;
    FIELDS_MAP("type", type, "label", label, "protocol", protocol,
               "bufferedAmount", bufferedAmount, "bytesSent", bytesSent,
               "messagesSent", messagesSent, "timestamp", timestamp);
  };
...
struct ApplyNetworkThrottleRequest {
  struct Data {
    ...
    FIELDS_MAP("secret", secret, "uplink", uplink, "downlink", downlink, "rtt",
               rtt);
  };
  absl::optional<bool> request = true;
  absl::optional<int64_t> id = generateID();
...
struct DownlinkBweNotification {
  struct Data {
    ...
    FIELDS_MAP("availableBitrate", availableBitrate, "desiredBitrate",
...
struct ConsumerScoreNotification {
  struct Score {
    ...
    FIELDS_MAP("producerScore", producerScore, "producerScores", producerScores,
               "score", score);
  };
...
struct ProducerScoreNotification {
  struct Score {
    ...
    absl::optional<int32_t> score;
    absl::optional<int64_t> ssrc;
    FIELDS_MAP("rid", rid, "encodingIdx", encodingIdx, "score", score, "ssrc",
               ssrc);
  };
...
struct PeerDisplayNameChangedNotification {
  struct Data {
    ...
    absl::optional<std::string> displayName;
    FIELDS_MAP("peerId", peerId, "oldDisplayName", oldDisplayName,
